...
if __name__ == "__main__":
    ...
    camera_info = _DictObjHolder({
        ...
        # "f_x": 34,         # focal length x
        # "f_y": 34,         # focal length y
        "u_x": 961,             # optical center x
        "u_y": 680,             # optical center y
        "camera_height": 100000,  # camera height in `mm`
        "pitch": 92.274,            # rotation degree around x
        "yaw": 0.898               # rotation degree around y
    })
    ...
    img = cv2.imread('./resources/sekonix_imgs/2.png', -1)
    ...
    ax.imshow(out_img)
    plt.savefig("./resources/tranformed/2_increase_pitch.png")